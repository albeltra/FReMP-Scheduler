...
"DNB": response.data["DNB"], 
"Drop Off": response.data["Drop Off"], 
"Pick Up": response.data["Pick Up"], 
"Status": response.data["Status"], 
"Total Price": response.data["Total Price"], 
"Deposit": response.data["Deposit"], 
"Delivery": response.data["Delivery"], 
"Generator": response.data["Generator"], 
"Canopy": response.data["Canopy"], 
"Cargo Trailer": response.data["Cargo Trailer"], 
"Large Cooler": response.data["Large Cooler"], 
"Small Cooler": response.data["Small Cooler"], 
"Notes": response.data["Notes"], 
"Tent": response.data["Tent"], 
"Grill": response.data["Grill"], 
